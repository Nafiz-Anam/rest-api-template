...
- **Automated workflow**: Pre-commit and pre-push hooks ensure code quality
...
```bash
# run all validations (lint, type-check, build)
yarn validate
...
This project includes comprehensive automated checks to ensure code quality:

### Git Hooks

**Pre-commit Hook** (`.husky/pre-commit`):

- Runs lint-staged on staged files (formatting, linting, type checking)
- Runs full project linting
- Runs build check
- Runs tests
...
- **TypeScript files**: Prettier formatting → ESLint fix → TypeScript type checking
- **JavaScript files**: Prettier formatting → ESLint fix
- **JSON/MD files**: Prettier formatting

### Available Scripts

```bash
# Comprehensive validation
yarn validate          # Runs lint + type-check + build
...
✅ **No broken commits**: All commits are automatically validated  
✅ **Consistent formatting**: Code is automatically formatted  
✅ **Type safety**: TypeScript errors are caught before commit  
✅ **Quality assurance**: Tests must pass before pushing  
